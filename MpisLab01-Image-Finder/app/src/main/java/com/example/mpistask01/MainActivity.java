package com.example.mpistask01;
...
import com.example.mpistask01.model.Image;
import com.example.mpistask01.model.ImageApi;
import com.example.mpistask01.model.ImageResponse;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creditsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "Разработал: Тунчик Антон АС-63", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void searchImages(ImageApi imageApi, String query) {
        ...
        String api = "UKg2Bxpfei-8MdsBN4thH7IbhPAfCQGnvkjV74mpajo";
